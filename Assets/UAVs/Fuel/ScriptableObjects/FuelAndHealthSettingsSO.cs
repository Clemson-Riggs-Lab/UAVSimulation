...
using UnityEngine;
using static UAVs.Camera.ScriptableObjects.UavCameraSettingsSO;
using static UAVs.Camera.ScriptableObjects.UavCameraSettingsSO.UavConditions;
using static UAVs.Camera.ScriptableObjects.UavCameraSettingsSO.UavVideoArtifacts;
...
namespace UAVs.Fuel.ScriptableObjects
{
