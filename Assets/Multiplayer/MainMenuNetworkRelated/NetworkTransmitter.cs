...
namespace Multiplayer
{
    public class NetworkTransmitter : NetworkBehaviour
    {
        ...
        public void SendBytesToClientsOnServerRpc(int transmissionId, byte[] data)
        {
        ...
        public IEnumerator SendBytesToClientsRoutine(int transmissionId, byte[] data)
        {
            ...
            RpcPrepareToReceiveBytesOnClientRpc(transmissionId, data.Length);
            yield return null;
            ...
            while (dataToTransmit.curDataIndex < dataToTransmit.data.Length - 1)
            {
                ...
                //send the chunk
                RpcReceiveBytesOnClientRpc(transmissionId, buffer);
        ...
        [ClientRpc]
        private void RpcPrepareToReceiveBytesOnClientRpc(int transmissionId, int expectedSize)
        {
        ...
        [ClientRpc]
        private void RpcReceiveBytesOnClientRpc(int transmissionId, byte[] recBuffer)
        {
