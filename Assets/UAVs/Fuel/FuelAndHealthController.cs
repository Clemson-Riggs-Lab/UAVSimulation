...
using UnityEngine;
using static UAVs.Fuel.ScriptableObjects.FuelAndHealthSettingsSO;
using static UAVs.Fuel.ScriptableObjects.FuelAndHealthSettingsSO.FuelComputationType;
using static UAVs.Fuel.ScriptableObjects.FuelAndHealthSettingsSO.FuelConditions;
using static UAVs.Fuel.ScriptableObjects.FuelAndHealthSettingsSO.FuelLeaksTypes;
using static UAVs.Fuel.ScriptableObjects.FuelAndHealthSettingsSO.HealthConditions;
